...
-- Ve a: https://supabase.com/dashboard/project/wfnaknuhwzmkriaetvtn/sql
...
-- Política para que pueda leer
CREATE POLICY "Allow authenticated users to read contact forms" ON contact_forms
  FOR SELECT
  USING (true);
