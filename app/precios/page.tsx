      ...
      <section className="py-24 px-6 bg-gradient-to-b from-gray-900 via-slate-900 to-black relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <CTAButton href="https://wa.me/34643045488?text=Hola%20Mateo,%20quiero%20saber%20m%C3%A1s%20sobre%20mis%20opciones%20de%20web." variant="secondary" size="lg" className="border-slate-600 hover:border-emerald-500/50 hover:bg-emerald-500/10 transition-all duration-300">
              <span className="flex items-center gap-2">
