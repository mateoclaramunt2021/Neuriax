...
export default function DemoLandingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Hubo un error al enviar el formulario. Por favor, inténtalo de nuevo o contacta directamente al +34 643 045 488');
    } finally {
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-950 to-slate-900 text-white py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-12 text-center">
          ...
          <a href="tel:+34643045488" className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300 font-medium transition-colors">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
