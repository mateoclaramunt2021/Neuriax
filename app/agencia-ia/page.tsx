        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full py-32 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-10">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-[#DD2A7B]/10 border border-[#DD2A7B]/30 text-[#DD2A7B] font-semibold rounded-2xl text-base transition-all hover:bg-[#DD2A7B]/20"
            >
